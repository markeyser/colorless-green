...
1. **[Introduction](00-02-intro.md)**

## **Part 1: The Foundations of Relevance**

1. **[Information Retrieval (IR) Fundamentals](01-01-ir-fundamentals.md)**
2. **[Lexical vs. Semantic Search](01-02-lexical-vs-semantic-search.md)**
3. **[Embeddings: The Language of Meaning](01-03-embeddings-language-of-meaning.md)**
...
1. **[Key IR Evaluation Metrics](04-01-key-ir-evaluation-metrics.md)**
2. **[The BEIR Framework for Reproducibility Research](04-02-the-beir-framework-for-reproducible-research.md)**
3. **[The Need for Domain Adaptation](04-03-need-for-domain-adaptation.md)**
4. **[The Engine of DAPT: A Deep Dive into Masked Language Modeling](04-04-engine-of-dapt-mlm.md)**
5. **[Training the 'Teacher': Supervised Fine-Tuning for the Cross-Encoder](04-05-training-the-teacher-cross-encoder.md)**
6. **[The Art of Mimicry: The Mechanics of Knowledge Distillation for Retrieval](04-06-mechanics-of-knowledge-distillation.md)**

## **Part 5: The Full Picture**

1. **[Beyond Retrieval—The Role of Context Refinement](05-01-annex-context-refinement.md)**
